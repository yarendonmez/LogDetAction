...
# Windows Türkçe encoding sorunlarını azaltmak için
...
train_path = r"C:\developer\LogDetAction\v2.0\split\train.jsonl"

output_dir = Path(r"C:\developer\LogDetAction\v2.0\qlora_test_model")
checkpoint_dir = Path(r"C:\developer\LogDetAction\v2.0\qlora_test_checkpoints")
...
def build_training_text(example):
    """
    Instruction dataset örneğini LLM eğitim formatına çevirir.
    """
