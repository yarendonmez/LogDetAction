...
train_path = r"C:\developer\LogDetAction\v2.0\split_classifier\train.jsonl"

output_dir = Path(r"C:\developer\LogDetAction\v2.0\qlora_classifier_test_model")
checkpoint_dir = Path(r"C:\developer\LogDetAction\v2.0\qlora_classifier_test_checkpoints")
...
def build_training_text(example):
    """
    Classifier-only instruction örneğini eğitim metnine çevirir.
    Bu model sadece Label üretmeyi öğrenir.
    """
...
def tokenize_example(example):
    """
    Metni tokenlara çevirir.
    Causal LM eğitiminde labels = input_ids yapılır.
    """
...
print("\nModel classifier-only QLoRA için hazırlanıyor...")
...
print("\nClassifier-only training başlıyor...\n")
...
print("\nClassifier-only training tamamlandı. Model kaydediliyor...")

model.save_pretrained(output_dir)
tokenizer.save_pretrained(output_dir)

print("\nClassifier-only adapter kaydedildi:")
print(output_dir)